...
\begin{frame}[fragile, plain]
<<rcode=TRUE, eval=FALSE>>=
# The ’seq’ function will generate more general sequences 
...
\pause 
<<rcode=TRUE, eval = FALSE, tidy = FALSE>>=
# height for 237 students by gender
# in the 'survey' data of library(MASS)
...
\pause 
<<rcode=TRUE, eval = FALSE, tidy = FALSE>>=
# is there a difference in height between
# males and females
...
<<rcode=TRUE, eval = FALSE, tidy = FALSE>>=
# boxplot to see the group difference
boxplot(InsectSprays$count ~ InsectSprays$spray)

# Store it in an object called aov.spray
...
# are gpa and rank related to gre
